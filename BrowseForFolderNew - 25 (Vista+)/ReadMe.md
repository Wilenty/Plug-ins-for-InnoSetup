With this dialog you can select any local or remote folder/location (I replaced default browse for folder dialog in this example on the "Select destination page"):
